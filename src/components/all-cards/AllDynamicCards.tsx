...
export default function AllDynamicCards({ card }: AllDynamicCardsProps) {
  return (
    <div className="group w-full overflow-hidden rounded-[12px] bg-white">
      <div className="relative aspect-[150/160] md:aspect-[170/182] lg:aspect-[180/194] xl:aspect-173/186 1xl:aspect-191/206 3xl:aspect-265/286 w-full overflow-hidden rounded-[12px]">
        ...
        {/* Bottom Content */}
        <div className="absolute bottom-0 left-0 right-0  p-2 md:p-2.5 lg:p-2.5 xl:p-2.5 1xl:p-3 3xl:p-4 text-white">
          <h3 className="truncate text-[12px] md:text-[13px] lg:text-[13px] xl:text-[12px] 1xl:text-[14px] 3xl:text-[19px] font-bold uppercase tracking-[0.5px]">{card.title}</h3>
