  ...
  if (isLoading) {
    return (
      <section className="w-full">
        <div className="container-custom py-10 text-center">Loading...</div>
      </section>
    );
  }
  ...
  return (
    <section>
      <div className="w-full px-[5px] pt-[20px] pb-0 md:px-[10px] md:pt-[25px] md:pb-0 lg:px-[10px] lg:pt-[27px] lg:pb-0 xl:px-[32px] xl:pt-[27px] xl:pb-0 1xl:px-[63px] 1xl:pt-[30px] 1xl:pb-0 3xl:px-[51px] 3xl:pt-[41px] 3xl:pb-0">
        <div className="rounded-[12px] md:rounded-[14px] xl:rounded-[20px] 3xl:rounded-[30px]  shadow-[2.03px_2.03px_7.93px_0px_#0000001A]">
          {/* Title + Search */}
          <div className="container-custom pt-[20px] px-5 md:pt-[24px] md:px-0 lg:pt-[26px] xl:pt-[29px] 1xl:pt-[33px] 3xl:pt-[58px]">
            <div className="flex flex-row items-center justify-between gap-2 md:flex-row md:items-center md:justify-between md:gap-5">
              <h1 className="font-normal leading-none text-[#1B2130] text-[18px] md:text-[26px] lg:text-[28px] xl:text-[32px] 1xl:text-[35px] 3xl:text-[48px]">
                Custom Offset Printing
              </h1>

              {/* SEARCH */}
              <div className="relative w-[120px] shrink-0 rounded-full p-[1.49px] bg-[radial-gradient(150.36%_227.1%_at_8.75%_100%,#757575_0%,rgba(201,201,201,0)_100%)] md:w-[130px] lg:w-[135px] xl:w-[125px] 1xl:w-[138px] 3xl:w-[191px]">
