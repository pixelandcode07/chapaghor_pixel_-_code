...
//                 className="absolute bottom-0 left-0 right-0 h-[70px] md:h-[80px] xl:h-[60px] 1xl:h-[80px] 3xl:h-[100px] bg-[#FD7034] rounded-b-[12px] md:rounded-b-[14px] xl:rounded-b-[15px] 3xl:rounded-b-[17px] flex items-end justify-center pb-[6px] md:pb-[8px] xl:pb-[9px] 1xl:pb-[10px] 3xl:pb-[12px] z-0"
//               >
...
//                 {/* Overlay Text */}
//                   {/* group-hover:bg-[linear-gradient(179.6deg,rgba(255,255,255,0)_18.12%,#FF2E00_67.58%)] */}
//                 {/* <div className="absolute bottom-0 left-0 w-full px-[9px] pb-[7px] xl:pb-[9px] md:pb-[10px] flex flex-col justify-end pt-[35%] ">
...
//                   </p>
//                 </div> */}
//                <div className="absolute bottom-0 left-0 w-full px-[9px] py-[7px] xl:py-[9px] md:py-[10px] flex flex-col justify-end border-t-[0.6px] border-solid [border-image:radial-gradient(150.36%_227.1%_at_8.75%_100%,#FFFFFF_0%,rgba(201,201,201,0)_100%)_1] backdrop-blur-[4.5157px]">
//   <h3 className="m-0 p-0 leading-none text-white font-bold text-[9px] xl:text-[12px] md:text-[13px] 1xl:text-[14px] 3xl:text-[16px] tracking-[1px] uppercase">
//     {product.name}
//   </h3>
...
export default function CardBox({ title, products }: CardBoxProps) {
  return (
    <div className="bg-white border-0 border-[#EAEAEC] rounded-[16px] pt-[6px] 3xl:pt-[18px] 1xl:pt-[13px] xl:pt-[12px] pb-[30px] 3xl:pb-[52px] px-[20px] md:pl-[19px] md:pr-0 pr-0 pl-[10px] 3xl:px-[55px] 1xl:px-[40px] xl:px-[36px]">
      ...
      <div className="flex justify-between items-center mb-[5px] md:mb-[11px] 3xl:mb-[10px] 1xl:mb-[7px] xl:mb-[7px]">
        {/* Title */}
        <h2 className="m-0 p-0 leading-none text-[#333333] text-[18px] md:text-[30px] 3xl:text-[42px] 1xl:text-[30px] xl:text-[28px] font-light font-['Helvetica Neue',Helvetica,sans-serif]">
          {title}
        </h2>
      ...
      <div className="flex gap-[12px] md:gap-[18px] overflow-x-auto overflow-y-hidden scroll-smooth pb-[4px] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden xl:grid xl:grid-cols-6 xl:overflow-visible 3xl:gap-[24px]">
        {products.map((product, idx) => (
          <div
            key={idx}
            className="relative w-[132px] min-w-[143px] shrink-0 md:w-[190px] md:min-w-[190px] md:shrink-0 xl:w-auto xl:min-w-0 xl:shrink"
          >
            {/* Card */}
            <div className="relative w-full aspect-[133/143] md:aspect-[189/204] xl:aspect-[264/285] overflow-hidden rounded-[12px] md:rounded-[12px] bg-gray-100">
              {/* Price Badge */}
              <div className="absolute top-2 right-2 bg-black/30 backdrop-blur-md text-white text-[7px] xl:text-[9px] px-1.25 xl:px-[9px] md:px-[9px] xl:py-0.75 md:py-0 py-0 rounded-full z-10 flex items-center gap-[1px] xl:gap-[3px]">
                <TakaIcon className="w-[7px] h-[11px] xl:w-[8px] xl:h-[10px] 1xl:w-[9px] 1xl:h-[11px] 3xl:w-[10px] 3xl:h-[12px] text-white" />
              ...
              {/* Text Section */}
              <div className="absolute bottom-0 left-0 w-full px-[9px] py-[7px] xl:py-[9px] md:py-[10px] flex flex-col justify-end">
  <h3 className="m-0 p-0 leading-none text-white font-bold text-[9px] xl:text-[12px] md:text-[13px] 1xl:text-[14px] 3xl:text-[16px] tracking-[1px] uppercase">
    {product.name}
  </h3>
