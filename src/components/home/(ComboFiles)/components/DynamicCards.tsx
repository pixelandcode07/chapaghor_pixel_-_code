  ...
  return (
    <div
      className={`relative group cursor-pointer ${
        isHorizontal ? "w-[189px] shrink-0 snap-start" : ""
      }`}
    >
      ...
      <div
        className={`absolute top-0 left-0 rounded-[23px] bg-white/10 backdrop-blur-md z-0 transition-colors duration-300 group-hover:bg-white/10 overflow-hidden ${
          isHorizontal
            ...
            : "w-full aspect-square 3xl:w-[283px] 3xl:aspect-[283/283]"
        }`}
      >
        {/* w-full h-[90%] */}
        <BorderBeam
            ...
            return (
              ...
              >
                ...
                {isFront && (
                  <>
                    {/* Bottom-right Cutout */}
                    <div className="absolute bottom-0 right-0 w-[76px] h-[76px] bg-black rounded-tl-[38px] z-40" />

                    {/* Top Curve */}
                    <div className="absolute bottom-[76px] right-0 w-6 h-6 z-40">
                      <svg
                        viewBox="0 0 32 32"
                    ...
                    {/* Left Curve */}
                    <div className="absolute bottom-0 right-[76px] w-6 h-6 z-40">
                      <svg
                        viewBox="0 0 32 32"
                        className="w-full h-full text-black"
                      >
                    ...
                    {/* Arrow */}
                    <div className="absolute bottom-[8px] right-[8px] w-[60px] h-[60px] rounded-full bg-[#F05A28] flex items-center justify-center z-50 transition-transform duration-300 group-hover:-translate-y-1 group-hover:translate-x-1">
                      <ArrowUpRight
