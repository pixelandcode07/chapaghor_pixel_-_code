      ...
      <div className="w-full md:pt-9 xl:pt-13.5 pb-8 xl:pb-13.75 3xl:pb-21.5 relative flex flex-col items-center">
        <div className="relative z-10 w-full flex flex-col items-center">
          ...
          {/* <motion.div
            ...
            className="grid grid-cols-3 md:grid-cols-4 xl:grid-cols-6 justify-center gap-4 xl:gap-6 3xl:gap-8.25"
          >
            {categories.map((category) => (
              ...
              >
                <motion.div
                  ...
                  whileHover="hover"
                  className="relative w-27.5 h-29.75 md:w-32.75 md:h-35.5 xl:w-32.25 xl:h-35 3xl:w-[196.39px] 3xl:h-[212.87px] rounded-[13.06px] md:rounded-[15.54px] xl:rounded-[15.23px] 3xl:rounded-[23.35px] cursor-pointer group z-10 hover:z-50 shadow-[6.9px_10.85px_45.37px_-5.92px_#DCDBDD]"
                >
                  <motion.div
                  ...
                  <button key={category._id} className="block outline-none">
                    ...
                    >
                      <motion.div
                        ...
                        className="absolute bottom-0 left-0 right-0 h-[95px] bg-[#FD7034] rounded-b-[17.5px] flex items-end justify-center mb-0.5 pb-3 z-0"
                      >
                        <h2 className="flex items-center justify-center gap-0.5 text-sm xl:text-[16px] 3xl:text-[23px] font-light text-white">
                          ORDER
