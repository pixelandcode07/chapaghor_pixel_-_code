...
export default function GraphicCategory({
  ...
  return (
    <div className="flex items-center gap-2 py-4 md:py-5 xl:py-10">
      <div className="flex min-w-0 flex-1 items-center gap-2 overflow-x-auto scrollbar-none">
        {categories.map((category) => {
          const active = category === activeCategory;
      ...
      <Button
        variant="ghost"
        className={`shrink-0 rounded-full border border-[#ff7043] px-6.5 py-2 text-[12px] font-normal cursor-pointer md:px-8.25 md:py-5 md:text-[15px] xl:px-9 xl:py-4.5 1xl:px-10.5 1xl:py-4.75 3xl:px-14 3xl:py-5.5 transition-all duration-500 ${
          highlightBrowse
