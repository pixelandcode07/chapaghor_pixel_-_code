...
export default function GraphicCategory({
  ...
  variant="outline"
  onClick={() => onCategoryChange(category)}
  className={`h-[28px] md:h-[37px] xl:h-[31px] 1xl:h-[36px] 3xl:h-[48px]  w-[90px] md:w-[117px] xl:w-[118px] 3xl:w-[152px] shrink-0 rounded-full border p-0 text-[12px] font-normal shadow-none transition-all cursor-pointer md:text-[15px] ${
    active
      ? "border-[#ff6b32] bg-[#ff6b32] text-white hover:bg-[#ff6b32] hover:text-white"
      : "border-gray-200 bg-white text-gray-500 hover:bg-gray-50"
  }`}
>
  {category}
      ...
      <Button
        variant="ghost"
        className={`hidden md:flex items-center justify-center w-[90px] md:w-[140px] xl:w-[160px] 3xl:w-[200px] h-[28px] md:h-[37px] xl:h-[31px] 1xl:h-[36px] 3xl:h-[48px]  shrink-0 rounded-full border border-[#ff7043]  text-[12px] font-normal cursor-pointer  md:text-[15px]  transition-all duration-500 ${
