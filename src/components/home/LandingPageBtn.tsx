...
export default function LandingPageBtn() {
    return (
        <Link href={'/view-all-product'} className="w-full sm:w-auto block">
            <Button
                variant={"ghost"}
                className="group relative w-full h-16 p-0 overflow-hidden rounded-md bg-transparent hover:bg-transparent text-[16px] font-medium shadow-sm transition-all duration-300"
            >
