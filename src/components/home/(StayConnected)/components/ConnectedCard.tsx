...
//   return (
//     <section className="container-custom my-1 w-full px-2 py-1 md:px-0">
...
//         <div className="flex min-w-max items-stretch justify-center gap-2 md:grid md:min-w-0 md:grid-cols-5 md:gap-3 lg:gap-4">
//           {socialLinks.map((social) => {
//             const Icon = social.icon;

//             return (
//               <div key={social.id} className="flex h-[168px] w-[130px] shrink-0 flex-col items-center rounded-[14px] border border-[#EEEEEE] bg-white px-2 py-4 shadow-[0_3px_15px_rgba(0,0,0,0.05)] md:h-[170px] md:w-auto md:px-2.5 lg:h-[180px] lg:px-3">
//                 <div className="flex h-10 w-10 items-center justify-center rounded-full md:h-11 md:w-11" style={{ color: social.color }}>
//                   <Icon className="h-9 w-9 md:h-10 md:w-10" />
//                 </div>

//                 <h3 className="mt-2 text-[14px] font-semibold leading-none text-black md:text-[15px] lg:text-[16px]">
//                   {social.name}
//                 </h3>

//                 <span className="mt-3 h-[3px] w-5 rounded-full md:mt-4" style={{ backgroundColor: social.color }} />

//                 <a href="#" className="mt-auto flex h-[36px] w-[102px] items-center justify-center rounded-full text-[13px] font-medium md:h-[38px] md:w-[108px] md:text-[14px]" style={{ color: social.color, backgroundColor: social.buttonBg }}>
...
export default function ConnectedCard() {
  return (
    <section className="container-custom my-1 w-full px-2 py-1 md:px-0">
      {/* XL / 1XL / 3XL */}
      <div className="hidden xl:grid xl:grid-cols-5 xl:gap-4 1xl:gap-5 3xl:gap-6 xl:max-w-[85vw] 1xl:max-w-[82vw] 3xl:max-w-[84vw] mx-auto">
        {socialLinks.map((social) => {
          const Icon = social.icon;
          ...
          return (
            <div
              key={social.id}
              className="flex flex-col items-center rounded-2xl border border-gray-100 bg-white p-6 text-center shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-all duration-300 hover:-translate-y-1 
            ...
            >
              ...
              <h3 className="mb-1 text-base font-medium text-[#000000] xl:text-[12px] 1xl:text-[14px] 3xl:text-[19px] tracking-[0.5px]">
                {social.name}
              </h3>

              <p className="mb-5 text-sm leading-snug font-normal text-[#757575] xl:text-[10px] 1xl:text-[12px] 3xl:text-[15px] tracking-[0.5px]">
                {social.description}
              </p>

              <a
                href="#"
                className="inline-flex items-center gap-1 xl:text-[12px] 3xl:text-[16px] font-medium transition-all hover:gap-2 tracking-[0.5px]"
