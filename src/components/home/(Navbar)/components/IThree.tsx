        ...
        >
            ...
            <div className="grid grid-cols-[repeat(4,244px)] auto-rows-[135px] gap-[2px]">
                {relatedSubCats.map((subCat, i) => {
                    ...
                    if (i === 0 || i === 6 || i === 9) {
                        return (
                            <Link
                                ...
                                className="col-span-1 row-span-1 w-[244px] h-[135px] bg-gray-50 border border-gray-100 rounded-lg p-6 flex flex-col justify-center "
                            >
                    ...
                    let gridClass = "col-span-1 row-span-1 w-[244px] h-[135px]";

                    if (i === 4) gridClass = "col-span-1 row-span-2 w-[244px] h-[272px]"; // Tall portrait
                    if (i === 5) gridClass = "col-span-1 row-span-2 w-[244px] h-[272px]"; // Tall portrait
