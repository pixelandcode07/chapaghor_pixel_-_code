...
export default function IThree({ relatedSubCats, category }: MegaMenuProps) {
    return (
        <motion.div
            ...
            className="absolute top-[180%] lg:-left-[480px] xl:-left-[524px] lg:w-[1100px] xl:w-[1380px] bg-[#FFFFFF] shadow-[0px_4px_15px_7px_#0000001C] border-2 rounded-b-xl z-50 lg:py-5 xl:pt-7.5 xl:pb-16.5 lg:pl-[80px] xl:pl-[90px] flex justify-start cursor-default"
        >
