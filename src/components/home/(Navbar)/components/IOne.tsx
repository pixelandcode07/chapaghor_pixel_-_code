...
export default function IOne({ relatedSubCats, category }: MegaMenuProps) {
    return (
        <motion.div
            ...
            className="absolute top-[169%] lg:-left-48 xl:-left-64 w-[1600px] lg:h-[380px] xl:h-[485px] bg-white shadow-[0px_4px_15px_7px_#0000001C] pt-7.5 lg:pl-12 xl:pl-20 pr-27.5 rounded-b-xl z-50 flex gap-0 cursor-default"
        >
            {/* Left: Image Cards */}
