...
export default function IFour({ relatedSubCats, category }: MegaMenuProps) {
    return (
        <motion.div
            ...
            className="absolute top-[234%] translate-x-[-56%] w-637.5  h-58.75 bg-[#FFFFFF] shadow-[0px_4px_15px_7px_#0000001C] rounded-b-xl z-50 flex justify-center cursor-default"
        >
