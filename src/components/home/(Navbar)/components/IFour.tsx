                ...
                {column.map((subCat) => (
                  ...
                  >
                    ...
                    <div className="relative overflow-hidden h-6">
                      ...
                      <span className="absolute left-0 top-0 block tracking-[0.5px] opacity-0 transition-all duration-200 [transform:translateY(-50%)_rotateX(90deg)] group-hover:opacity-100 group-hover:[transform:translateY(0)_rotateX(0)] text-[#3C3C3C]">
                        {subCat.name}
                      </span>
                    </div>
                  </Link>
