...
//           border-radius: 7px;
//           background: #FD7034; /* Matches the sweep color exactly */
//           opacity: 0;
                              ...
                              <>
                                ...
                                {index === 1 ? (
                                  ...
                                  >
                                    ...
                                    <div className="flex-1 grid grid-cols-4 gap-y-4 gap-x-6 border-l border-gray-100 pl-8">
                                      {relatedSubCats.map((subCat) => (
                                        <Link
                                          key={subCat._id}
                                          href={`/category/${category.slug}/${subCat.slug}`}
