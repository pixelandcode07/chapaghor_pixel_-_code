...
//     return (
//         <section className="w-screen pb-28.25 bg-white relative overflow-hidden flex flex-col items-center">
...
//                     <div className="absolute top-1/2 left-[5%] md:left-[18%] lg:left-[20%] xl:left-[11%] -translate-y-1/2 z-20 hidden sm:block">
//                         <Button
//                             variant="default"
//                             size="icon"
//                             className="w-10 h-10 xl:w-12  xl:h-12  bg-[#012C60] hover:bg-[#012C60]/90 text-white rounded-md shadow-lg"
...
//                     <div className="absolute top-1/2 right-[5%] md:right-[16.5%] lg:right-[19.5%] xl:right-[10.5%] -translate-y-1/2 z-20 hidden sm:block">
//                         <Button
//                             variant="default"
//                             size="icon"
//                             className="w-10 h-10 xl:w-12  xl:h-12  bg-[#012C60] hover:bg-[#012C60]/90 text-white rounded-md shadow-lg"
