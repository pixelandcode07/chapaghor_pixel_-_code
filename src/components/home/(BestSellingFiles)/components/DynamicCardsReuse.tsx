...
//                     <div className="relative 3xl:w-[315px] 3xl:aspect-[315/327]">
...
//                             {/* FIX: Expanded width/height by 4px and shifted -4px (-bottom-1, -right-1) to overlap the gap */}
//                             <div className="absolute -bottom-1 -right-1 w-[68px] h-[68px] xl:w-[80px] xl:h-[80px] bg-white rounded-tl-[32px] xl:rounded-tl-[38px] z-10 pointer-events-none" />

//                             {/* Concave curve (Top edge) */}
//                             <div className="absolute bottom-[63px] 3xl:bottom-[75px] 3xl:-right-0.5 w-5 h-5 xl:w-8 xl:h-8 z-10 pointer-events-none">
...
//                             <div className="absolute -bottom-0.5 right-[63px] 3xl:right-[75px] w-5 h-5 xl:w-8 xl:h-8 z-10 pointer-events-none ">
//                                 <svg viewBox="0 0 32 32" fill="none" className="w-full h-full text-white">
//                                     <path d="M0 32 A 32 32 0 0 0 32 0 L 32 32 Z" fill="currentColor" />
//                                 </svg>
//                             </div>
...
//                         {/* Circular Button */}
//                         <div className="absolute bottom-[4px] right-[4px] xl:bottom-[6px] xl:right-[6px] w-[50px] h-[50px] xl:w-[60px] xl:h-[60px] bg-[#111827] group-hover:bg-[#FD7034] text-white flex items-center justify-center rounded-full transition-transform duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 z-20 shadow-md">
