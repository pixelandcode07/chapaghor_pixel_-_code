...
//                         {/* Inner image box */}
//                         <div className="absolute inset-0 rounded-[16px] xl:rounded-[20px] overflow-hidden bg-white border border-gray-100">
//                             <Image
//                                 src={product.src}
//                                 alt={product.name}
//                                 fill
...
//                             <div className="absolute bottom-[63px] 3xl:bottom-[75px] 3xl:-right-0.5 w-5 h-5 xl:w-6 xl:h-6 z-10 pointer-events-none">
